...
void setup() {
  ...
  if (oled_active) {
    ...
    Serial.println("If you see this, the Nano is attempting to turn on the OLED.");
    Serial.println("Note: The Arduino cannot physically detect if the OLED is connected because there is no MISO pin. It just blindly sends data.");
    ...
    Serial.println("It should currently be displaying 'Initializing Hardware...'");
    delay(1500);
    display.fillScreen(BLACK);
